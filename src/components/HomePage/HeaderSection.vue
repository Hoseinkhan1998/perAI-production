...
<template>
  <!-- عکس اصلی -->
  <div class="flex justify-center pt-[100px]  bg-cover bg-center h-[700px]" :style="{ backgroundImage: `url(/images/landing.png)` }">
    <div class="text-neutral-100 flex flex-col gap-5">
