    ...
    <div class="col-span-full">
      <swiper
        ...
        <swiper-slide v-for="(slide, index) in slides" :key="index">
          <router-link :to="slide.url" class="flex cursor-pointer hover:scale-110 transition-all duration-300 justify-center bg-cover bg-center inset-0 relative" :style="{ backgroundImage: `url(${slide.image})`, height: '50vh' }">
            <div class="absolute inset-0 opacity-100 bg-[#00000069]" :style="{ height: '50vh' }"></div>
